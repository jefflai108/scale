...
def main():
	...
	model.add(Bidirectional(LSTM(256, dropout=0.9, recurrent_dropout=0.9, return_sequences=True)))
	model.add(Bidirectional(LSTM(128, dropout=0.9, recurrent_dropout=0.9, return_sequences=False)))
